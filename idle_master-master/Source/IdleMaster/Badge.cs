...
namespace IdleMaster
{
    public class Badge
    {
        ...
        {
            RemainingCard = 1;//string.IsNullOrWhiteSpace(remaining) ? 0 : int.Parse(remaining);
            HoursPlayed = 5;//string.IsNullOrWhiteSpace(hours) ? 0 : double.Parse(hours, new NumberFormatInfo());
        }
